...
int poisson(float **p, float **rhs, char **flag, int imax, int jmax,
    ...
    float *res, int ifull,  double *possion_p_loop_time_taken, double *possion_res_loop_time_taken)
{
    int i, j, iter;
...
//                    if ((i+j) % 2 != rb) { continue; }
        ...
        *possion_p_loop_time_taken += MPI_Wtime() - start;
        ...
        *possion_res_loop_time_taken += MPI_Wtime() - start;
